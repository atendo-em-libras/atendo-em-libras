...
const About = () => {
  ...
  return (
    <>
          ...
          >
            <Box basis="60%">
              ...
              <ParagraphStyled lineHeight="35px" fill>
                ...
                comunicação humanizada em Libras, trazendo autonomia e independência para as pessoas surdas no
      ...
      <SectionStyled>
        <Container justify="center">
          <Box pad={{ vertical: 'xlarge' }} align="center" fill>
            <Heading level="2" margin={{ bottom: 'xlarge' }}>
              As idealizadoras
            </Heading>
            <Box direction={contentDirection} fill justify="between">
      ...
      <SectionStyled>
        <Container>
          <Box align="center" pad={screenSize === 'small' ? { vertical: 'small' } : { vertical: 'xlarge' }}>
            <Heading level="2" margin={{ bottom: 'xlarge' }}>
              Conheça quem faz parte
            </Heading>
            <Box direction="row" wrap fill justify="center">
              {loading ||
